// FILE: poly.h
// CLASS PROVIDED:
//   class polynomial (in the namespace coen70_lab4)
...
//     3) The first coeficient chould be followed by an plain x: 4.3x, not 4.3x^1
...
//          and then printed unsigned: -2.5x^2 - 4.3x...
